...
type ButtonProps = PropsWithChildren<TButton> & ButtonHTMLAttributes<HTMLButtonElement>;

/** TODO: button 요소 자체가 disabled 될 땐 조건부 interactive가 안 먹힘 ref로 감시해야 하나?  */

export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variants = 'primary', size = 'default', interactive = 'default', className, children, ...props }: ButtonProps, ref) => {
    return (
      <button
        ref={ref}
        type="button"
